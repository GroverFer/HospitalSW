                                ...
                                <td>
                                    ...
                                    <template v-if="especialidad.condicion">
                                        <button type="button" class="btn btn-danger btn-sm"
                                            @click="desactivarEspecialidad(especialidad.id)">
                                            <i class="icon-trash"></i>
                                        </button>
                                    </template>
                                    <template v-else>
                                        <button type="button" class="btn btn-info btn-sm"
                                            @click="activarEspecialidad(especialidad.id)">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary"
                            @click="registrarEspecialidad()">Guardar</button>
        ...
        methods: {
            ...
            validarEspecialidad() {
                ...
                if (!this.descripcion) this.errorMostrarMsjEspecialidad.push(
                    "La descripcion de la especialidad no puede estar vacía.");

                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" v-model="buscar" @keyup.enter="listarDepartamento(1,buscar,criterio)"
                                    class="form-control" placeholder="Texto a buscar">
                                <button type="submit" @click="listarDepartamento(1,buscar,criterio)"
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="departamento in arrayDepartamento" :key="departamento.id">
                                <td>
                                    <button type="button" @click="abrirModal('departamento','actualizar',departamento)"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==1" class="btn btn-primary"
                            @click="registrarDepartamento()">Guardar</button>
                        <button type="button" v-if="tipoAccion==2" class="btn btn-primary"
                            @click="actualizarDepartamento()">Actualizar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            validarDepartamento() {
                ...
                if (!this.nombre) this.errorMostrarMsjDepartamento.push(
            ...
            desactivarDepartamento(id) {
                ...
                swalWithBootstrapButtons
                    .fire({
                        title: "Estas seguro desactivar este Departamento?",
                        icon: "warning",
                            ...
                            axios
                                ...
                                .then(function (response) {
                                    ...
                                    swalWithBootstrapButtons.fire(
                                        "Desactivado!",
                                        "El Departamento ha sido desactivado con exito.",
                                        "success"
                                    );
                                })
                                .catch(function (error) {
            ...
            activarDepartamento(id) {
                ...
                swalWithBootstrapButtons
                    .fire({
                        title: "Estas seguro de Activar este Departamento?",
                        icon: "warning",
                        showCancelButton: true,
                        confirmButtonText: "Aceptar",
                        cancelButtonText: "Cancelar",
                        ...
                        if (result.value) {
                            ...
                            axios
                                ...
                                .then(function (response) {
                                    ...
                                    swalWithBootstrapButtons.fire(
                                        "Activado!",
                                        "El Departamento ha sido activado con exito.",
                                        "success"
                                    );
                                })
                                .catch(function (error) {
